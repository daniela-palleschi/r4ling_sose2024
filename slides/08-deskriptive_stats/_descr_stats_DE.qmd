...
# in the end let's just keep using the data version from WiSe23/24 to keep things static
```
...
#| tbl-cap: Zusammenfassende Statistiken der datasauRus-Datensätze
#| output-location: column-fragment
#| echo: false
datasaurus_dozen |>
    group_by(dataset) |>
...
[Anhang 7: Deskriptive Statistik](https://daniela-palleschi.github.io/r4ling/appendices/00-aufgaben.html#sec-app_desc_stats) auf der Website des Kurses.
